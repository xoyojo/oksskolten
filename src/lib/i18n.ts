...
const dict = {
  ...
  'article.similarAlreadyRead': { ja: 'この記事は ${feedNames} でも報じられており、既に読んでいます', en: 'You already read this story from ${feedNames}' },
  'article.similarCoveredBy': { ja: 'この記事は ${feedNames} でも報じられています', en: 'This story was also covered by ${feedNames}' },
